...
const TabsAdmin = () => {
    ...
    return (
        <Stack sx={{ marginRight: '130px' }} direction="row">
            <Button id='user' type='button' onClick={handleClick} sx={{ borderTopLeftRadius: '15px', marginLeft: '10px',marginRight: '10px', borderTopRightRadius: '15px', borderBottomLeftRadius: '0px', borderBottomRightRadius: '0px' }} variant={userScreen}>מדריכים \ אנשי מקצוע</Button>
